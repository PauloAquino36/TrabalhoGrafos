...
public:
    ...
    int getNumArestasGrafo(){ return numArestasGrafo; };                            // Retorna o numero de arestas do grafo
    int incrementaNumArestasGrafo(){ return numArestasGrafo++; };                   // Incrementa o numero de arestas do grafo
    int decrementaNumArestasGrafo(){ return numArestasGrafo--; };                   // Decrementa o numero de arestas do grafo
